      ...
      <Grid container spacing={3} className={ProjectsCss.projectInfo}>
        ...
        <Grid item xs={5.8} className={ProjectsCss.verticalBlock}>
          ...
          <div className={ProjectsCss.verticalSection}>
            <div className={ProjectsCss.projectDescriptionText}>{sec1}</div>
            ...
            <div>
              {sec1Img === "none" ? (
                ...
                <img
                  alt="sec1"
                  className={ProjectsCss.verticalImage}
                  src={require(`../images/${sec1Img}`)}
                ></img>
              )}
            </div>
          </div>
        ...
        <Grid item xs={5.8} className={ProjectsCss.verticalBlock}>
          ...
          <div className={ProjectsCss.verticalSection}>
            <div className={ProjectsCss.projectDescriptionText}>{sec2}</div>
            <div>
              {sec2Img !== "none" && (
                <img
                  alt="sec2"
                  className={ProjectsCss.verticalImage}
                  src={require(`../images/${sec2Img}`)}
                ></img>
              )}
            </div>
          </div>
